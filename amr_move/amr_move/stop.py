...
class GoalPublisher(Node):
    ...
    def send_goal(self):
        ...
        goal_msg.pose.pose.position.x = 0.2 # Target X coordinate
        goal_msg.pose.pose.position.y = -0.1  # Target Y coordinate
        ...
        goal_msg.pose.pose.orientation = self.euler_to_quaternion(-0.55, 0.835, goal_yaw)
